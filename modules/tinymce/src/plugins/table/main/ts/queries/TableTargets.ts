...
const noMenu = function (cell: Element<DomElement>): RunOperation.CombinedTargets {
  return {
...
const forMenu = function (selections, table, cell: Element<DomElement>): RunOperation.CombinedTargets {
  return {
    element: Fun.constant(cell),
